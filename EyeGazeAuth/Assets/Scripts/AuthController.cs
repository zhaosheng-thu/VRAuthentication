...
public class AuthController : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        Name = numStudy.ToString().ToLower() + "-" + Name + "-" + month.ToString() + day.ToString();
    }
    ...
    void Update()
    {
        ...
        if (Mathf.Max(closeL, closeR) > 0.70)
        {
            // 尚未更新
    ...
    public float GetEyeClose()
    {
        return Mathf.Max(closeL, closeR);
    }

    public enum NumStudy
    {
        None,
        study1,
        study2,
